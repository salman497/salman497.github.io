...
const initChalkboard = function (Reveal) {
  ...
  var pen = {
    src: path + 'img/boardmarker-black.png',
    width: 24,
    height: 24
  };
  ...
  function createPalette(colors, length) {
    ...
    // pen tool (add this before color pickers)
    var penButton = document.createElement('li');
    penButton.setAttribute('data-tool', 'pen');
    var penImg = document.createElement('img');
    penImg.src = pen.src;
    penImg.height = "24";
    penImg.width = "24";
    penImg.style.marginTop = '10px';
    penImg.style.marginRight = '0';
    penImg.style.marginBottom = '0';
    penImg.style.marginLeft = '0';
